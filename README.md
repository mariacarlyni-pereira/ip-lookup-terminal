...
- **CSS3**: Layout baseado em Flexbox/Grid com estética "Matrix Glow".
- **JavaScript (ES6+)**: Manipulação de DOM e consumo de API Assíncrona (Fetch).
- **Ipinfo API**: Engine de inteligência de IP.
